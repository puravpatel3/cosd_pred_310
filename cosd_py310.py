...
def download_and_load_model():
    model_url = 'https://github.com/puravpatel3/cosd_pred_310/raw/main/rf_310_modality.pkl.gz'
...
data_file = r'https://github.com/puravpatel3/cosd_pred_310/raw/main/cosd310_ci_rf_modality.csv'
...
st.title('COSD Prediction Model (Python 3.10)')
